...
const FILTER_OPTIONS = [
  {
    id: "In-Person",
    label: "In-Person",
    check: (app: Appointment) => app.mode === AppointmentMode.InPerson,
  },
  {
    id: "Video",
              ...
              <div>
                ...
                <div className="space-y-2">
                  {FILTER_OPTIONS.map((filter) => (
                    <label
                      key={filter.id}
                      className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors select-none"
                    >
